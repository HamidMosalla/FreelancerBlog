define("ManageArticleCommentModule", function () {
    "use strict";

    function deleteArticleCommentHandler(e) {
        e.preventDefault();
    ...
    function approveCommentHandler(e) {
    ...
    function showArticleDetailHandler(e) {
    ...
    var Run = function () {
        $(".DeleteArticleCommentButton").on("click", deleteArticleCommentHandler);
        $(".commentApprovalCheckBox").on("change", approveCommentHandler);
        $(".articleCommentDetail").on("click", showArticleDetailHandler);
        articleEditButtonClickEvent();
    };
