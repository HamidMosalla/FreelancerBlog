var articleDetailModule = (function ($) {
    ...
    function articleRatingChangeHandler() {
    ...
    var Run = function () {
        $('#ArticleRating').rating({ extendSymbol: articleRatingHandler });
        $('#ArticleRating').on("change", articleRatingChangeHandler);
        $("#commentForm").on("submit", commentSubmitHandler);
        $(".replyButton").on("click", replyHandler);
        $("body").on("click", "#cancelReplyButton", cancelReplyHandler);
        setupCommentCharacterCounter();
        setUpSpinner();
    };
